        ...
        success: function (response, status, request) {
            ...
            $('#container .form-wrap').append(`
                    ...
                    <div class="button-wrap controls disappear-at-next-step">
                        <a href="javascript:resendVerificationCode(${isAdmin})" class="button resend button-line">${lang('resend')}</a>
                        <a href="javascript:confirmVerificationCode(${isAdmin})" class="button confirm button-fill">${lang('confirm')}</a>
                    </div>
                `)
            startTimer();
        },
