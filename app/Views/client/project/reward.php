        ...
        <div class="content-box">
            ...
            <div class="page" id="page-2" style="display: none">
                ...
                <div class="form-wrap">
                    ...
                    <div class="input-wrap comment">
                        ...
                        <textarea name="inquirer_comment"></textarea>
                    </div>
            ...
            <div class="page" id="page-3">
                <div class="purchase-item-box">
                    ...
                    <?php } ?>
                    <div class="purchase-item-wrap form-wrap">
                        <div class="input-wrap inline">
                            <p class="input-title"><?= lang('Service.name') ?></p>
                            <input type="name" name="inquirer_name" value="test" readonly/>
                        </div>
                        <div class="input-wrap inline">
                            <p class="input-title"><?= lang('Service.email') ?></p>
                            <input type="email" name="inquirer_email" value="test" readonly/>
                        </div>
                        <div class="input-wrap inline">
                            <p class="input-title"><?= lang('분류') ?></p>
                            <input type="text" name="code_reaction_name" value="분류" readonly/>
                            <input hidden type="text" name="code_reaction_id" value="1" readonly/>
                        </div>
                        <div class="input-wrap inline">
                            <p class="input-title"><?= lang('요청사항') ?></p>
                            <input type="text" name="inquirer_comment"
                                   value="esdfdsdgdsgsgsdgsgsdgsdgsgsdgsdgsdgsdgsdgsdgsdgd" readonly/>
                        </div>
                    </div>
                    <div class="button-wrap">
                        <a class="button more button-line" href="#"><?= lang('더보기') ?></a>
                    </div>
                </div>
                <div class="payment-box">
                    <div class="form-wrap">
                        ...
                        <div class="terms">
                            <ul>
                                <li>
                                    <p><?=sprintf(lang("%s에 동의합니다"), '<a href="#">'.lang('주문정보 및 서비스 이용약관').'</a>')?></p></li>
